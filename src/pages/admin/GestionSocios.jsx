...
        <div className="pt-2">
          <h4 className="text-lg font-semibold mb-2">Información de Afiliación</h4>
          <div className={detailItemClass}>
...
        </svg>
      </div>
      <h3 className="text-xl font-bold text-black mb-2">Confirmar Eliminación</h3>
      <p className="text-gray-600 mb-6">
        ¿Estás seguro de que deseas eliminar permanentemente al socio **{socio.Nombre} {socio.Apellido}** ({socio.CI})?
...
        <div>
          <h2 className="font-extrabold text-3xl mb-1 text-black">Gestión de Socios</h2>
          <p className="text-gray-500 text-sm font-light">Administra y consulta la información de todos los socios</p>
        </div>
...
          <p className="text-gray-500 text-lg">No se encontraron socios con los criterios de búsqueda.</p>
        </div>
      ) : viewMode === "grid" ? (
        /* Grid View */
