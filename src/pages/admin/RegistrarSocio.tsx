...
export default function RegistrarSocio() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'dni') {
      ...
      if (inputDigits.length > 2) {
        ...
        formattedExpiry =
          inputDigits.slice(0, 2) + '/' + inputDigits.slice(2, 4);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.dni.length !== 8 || isNaN(Number(formData.dni))) {
      setErrorMessage(
        'La Cédula de Identidad (C.I.) debe ser un número válido de **exactamente 8 dígitos**.'
      );
      setLoading(false);
      return;
    }
    ...
    if (formData.metodoPago === 'tarjeta') {
      ...
      if (rawCardNumber.length !== 16) {
        // Usamos el valor sin espacios para la validación de 16 dígitos
        setErrorMessage(
      ...
      if (
        ...
        setErrorMessage(
          'La fecha de vencimiento debe estar en formato MM/AA (Mes/Año).'
        );
        setLoading(false);
        return;
      }
    ...
    try {
      ...
      if (
        ...
        rawCardNumber === '4000400040004000'
      ) {
        throw new Error(
          'La tarjeta ha sido rechazada. Fondos insuficientes o datos inválidos. Intente con otra tarjeta.'
        );
      }
      ...
      setSuccessMessage(
        `✅ Socio ${formData.nombre} ${formData.apellidos} registrado con éxito.`
      );
      ...
      <div className='mx-auto px-4 md:px-8 max-w-6xl space-y-6'>
        ...
        <div>
          ...
          <p className='text-gray-500 text-sm font-light'>
            Complete los datos personales, de dirección, profesionales y de
            pago.
          </p>
        </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
              ...
              <div>
                ...
                >
                  ...
                  <option value='trimestral'>
                    Trimestral - Bs. 1000/3 meses
                  </option>
                  <option value='semestral'>
                    Semestral - Bs. 1950/6 meses
                  </option>
              ...
              {formData.metodoPago === 'tarjeta' && (
                <div className='md:col-span-3 pt-4 border-t border-gray-100 mt-4'>
                  <h4 className='font-semibold text-base mb-3 text-black'>
