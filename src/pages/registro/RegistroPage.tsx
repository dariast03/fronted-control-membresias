...
interface RegistrationData {
  ...
  phone: string
  // Paso 3: Plan y Pago
  selectedPlan: "monthly" | "quarterly" | "annual" | null
...
export default function RegistroPage() {
  ...
  const validateStep2 = () => {
    if (!formData.idNumber || !formData.profession || !formData.licenseNumber || !formData.phone) {
      setErrors("Todos los campos son obligatorios")
      return false
    }
    return true
  ...
  const handleCompletePayment = () => {
    ...
    alert("¡Registro completado exitosamente! Bienvenido al Colegio de Profesionales")
    navigate("/login")
  }

  const plans = [
    { id: "monthly", name: "Plan Mensual", price: 50, period: "mes", discount: null },
    { id: "quarterly", name: "Plan Trimestral", price: 135, period: "trimestre", discount: "10%" },
    { id: "annual", name: "Plan Anual", price: 480, period: "año", discount: null },
  ]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-xl font-bold text-gray-900">Colegio de Profesionales</h1>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {currentStep === 1 && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Regístrate para solicitar tu membresía</p>
            </div>

            {errors && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">{errors}</div>
            )}
        ...
        {currentStep === 2 && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Solicitud de Membresía</h2>
              <p className="text-gray-600">Complete sus datos profesionales para continuar</p>
            </div>
            ...
            >
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-gray-700">
                  <strong>Nota:</strong> Sus datos serán verificados por nuestro equipo. Recibirá una notificación una
                  vez aprobada su solicitud.
                </p>
              </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Seleccione su Plan</h2>
              <p className="text-gray-600">Elija el plan que mejor se adapte a sus necesidades</p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Planes de Membresía</h3>
                  <div className="space-y-3">
                    {plans.map((plan) => (
                      <button
                        key={plan.id}
                        onClick={() => updateField("selectedPlan", plan.id as any)}
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                  formData.selectedPlan === plan.id ? "border-gray-900" : "border-gray-300"
                                }`}
                              >
                                {formData.selectedPlan === plan.id && (
                            ...
                            <p className="text-sm text-gray-600 ml-7">
                              {plan.discount && (
                                <span className="text-green-600 font-medium">Ahorra {plan.discount}</span>
                              )}
                              {!plan.discount && `Pago mes a ${plan.period}`}
                            </p>
                          </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                            formData.paymentMethod === "card" ? "border-gray-900" : "border-gray-300"
                          }`}
                        >
                          {formData.paymentMethod === "card" && (
                            <div className="w-3 h-3 rounded-full bg-gray-900"></div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                            formData.paymentMethod === "transfer" ? "border-gray-900" : "border-gray-300"
                          }`}
                        >
                          {formData.paymentMethod === "transfer" && (
                            <div className="w-3 h-3 rounded-full bg-gray-900"></div>
                  ...
                  {formData.paymentMethod === "card" && (
                    <div className="space-y-4 pt-4 border-t border-gray-200">
                      <div>
                        <label className="block text-sm font-medium text-gray-900 mb-2">Número de Tarjeta</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-900 mb-2">Nombre en la Tarjeta</label>
                        <input
                          type="text"
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900">
                        {selectedPlanData ? selectedPlanData.name.replace("Plan ", "") : "-"}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
